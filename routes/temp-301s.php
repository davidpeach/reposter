<?php
	...
	// New thirty three
	Route::get('2016/08/my-first-day-in-firewatch', function () {
		return Redirect::to('https://newthirtythree.com/2016/08/my-first-day-in-firewatch', 301);
	});

	Route::get('2016/08/my-second-day-in-firewatch-a-write-up', function () {
		return Redirect::to('https://newthirtythree.com/2016/08/my-second-day-in-firewatch-a-write-up', 301);
	});

	Route::get('2016/08/there-is-no-love-in-rust-7-pieces-of-advice-for-new-players', function () {
		return Redirect::to('https://newthirtythree.com/2016/08/there-is-no-love-in-rust-7-pieces-of-advice-for-new-players', 301);
	});

	Route::get('2016/09/first-month-rust-write', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/first-month-rust-write', 301);
	});

	Route::get('2016/09/trying-out-rise-of-the-tomb-raider-on-gnu-slash-linux', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/trying-out-rise-of-the-tomb-raider-on-gnu-slash-linux', 301);
	});

	Route::get('2016/11/tove-los-short-film-fairy-dust', function () {
		return Redirect::to('https://newthirtythree.com/2016/11/tove-los-short-film-fairy-dust', 301);
	});

	Route::get('2016/11/5-favourite-debut-albums', function () {
		return Redirect::to('https://newthirtythree.com/2016/11/5-favourite-debut-albums', 301);
	});

	Route::get('2016/02/laravel-blade-push-and-stack', function () {
		return Redirect::to('https://newthirtythree.com/2016/02/laravel-blade-push-and-stack', 301);
	});

	Route::get('2015/11/what-is-the-indieweb-and-why-we-need-it', function () {
		return Redirect::to('https://newthirtythree.com/2015/11/what-is-the-indieweb-and-why-we-need-it', 301);
	});

	Route::get('2014/11/throwing-mud-up-a-wall', function () {
		return Redirect::to('https://newthirtythree.com/2014/11/throwing-mud-up-a-wall', 301);
	});

	Route::get('2016/10/word-bond-negan-shows-boss', function () {
		return Redirect::to('https://newthirtythree.com/2016/10/word-bond-negan-shows-boss', 301);
	});

	Route::get('2016/09/dont-friends-round-round-brotherhood', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/dont-friends-round-round-brotherhood', 301);
	});

	Route::get('2016/09/5-favourite-moments-buffy-vampire-slayer', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/5-favourite-moments-buffy-vampire-slayer', 301);
	});

	Route::get('2016/09/i-enjoyed-the-new-ben-hur-film', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/i-enjoyed-the-new-ben-hur-film', 301);
	});

	Route::get('2016/09/american-horror-story-6-latest-teaser', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/american-horror-story-6-latest-teaser', 301);
	});

	Route::get('2016/09/life-on-the-road-with-david-brent', function () {
		return Redirect::to('https://newthirtythree.com/2016/09/life-on-the-road-with-david-brent', 301);
	});

	Route::get('2016/08/suicide-squad-lot-fun', function () {
		return Redirect::to('https://newthirtythree.com/2016/08/suicide-squad-lot-fun', 301);
	});

	Route::get('2016/08/stranger-things-series-one-a-write-up', function () {
		return Redirect::to('https://newthirtythree.com/2016/08/stranger-things-series-one-a-write-up', 301);
	});

	Route::get('2016/07/star-trek-beyond-pretty-good', function () {
		return Redirect::to('https://newthirtythree.com/2016/07/star-trek-beyond-pretty-good', 301);
	});

	Route::get('2016/07/tropico-short-film-starring-lana-del-rey', function () {
		return Redirect::to('https://newthirtythree.com/2016/07/tropico-short-film-starring-lana-del-rey', 301);
	});

	Route::get('2016/07/godzilla-vs-mito-komon', function () {
		return Redirect::to('https://newthirtythree.com/2016/07/godzilla-vs-mito-komon', 301);
	});

	Route::get('2016/07/scary-mary-trailer', function () {
		return Redirect::to('https://newthirtythree.com/2016/07/scary-mary-trailer', 301);
	});
